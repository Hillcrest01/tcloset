  <footer class="footer footer_type_2">
    <div class="footer-middle container">
      <div class="row row-cols-lg-5 row-cols-2">
        <div class="footer-column footer-store-info col-12 mb-4 mb-lg-0">
          ...
          <p class="footer-address"> Egerton, Nakuru-kenya </p>
          <p class="m-0"><strong class="fw-medium">sales@tattianacloset.co.ke</strong></p>
          <p><strong class="fw-medium">+254 714 130 512</strong></p>
    ...
    <div class="footer-bottom">
      <div class="container d-md-flex align-items-center">
        <span class="footer-copyright me-auto"> &copy; {{ date('Y')}} {{ config('app.name') }}</span>
